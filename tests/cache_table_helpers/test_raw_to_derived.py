...
from biodata_cache.cache_table_helpers.raw_to_derived import raw_to_derived
...
@patch("biodata_cache.cache_table_helpers.raw_to_derived.source_data")
...
@patch("biodata_cache.cache_table_helpers.raw_to_derived.asset_basics")
@patch("biodata_cache.cache_table_helpers.raw_to_derived.source_data")
