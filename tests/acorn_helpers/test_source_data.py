...
def test_source_data_cache_hit(mock_tree, mock_client_class):
...
@patch("zombie_squirrel.acorn_helpers.source_data.MetadataDbClient")
@patch("zombie_squirrel.acorn_helpers.source_data.acorns.TREE")
def test_source_data_cache_miss(mock_tree, mock_client_class):
    mock_tree.scurry.return_value = pd.DataFrame()
    mock_client_instance = MagicMock()
    mock_client_class.return_value = mock_client_instance
...
@patch("zombie_squirrel.acorn_helpers.source_data.MetadataDbClient")
@patch("zombie_squirrel.acorn_helpers.source_data.acorns.TREE")
def test_source_data_multiple_sources(mock_tree, mock_client_class):
    mock_tree.scurry.return_value = pd.DataFrame()
    mock_client_instance = MagicMock()
    mock_client_class.return_value = mock_client_instance
    mock_client_instance.retrieve_docdb_records.return_value = [{
...
@patch("zombie_squirrel.acorn_helpers.source_data.MetadataDbClient")
@patch("zombie_squirrel.acorn_helpers.source_data.acorns.TREE")
def test_source_data_no_source_data(mock_tree, mock_client_class):
    mock_tree.scurry.return_value = pd.DataFrame()
    mock_client_instance = MagicMock()
    mock_client_class.return_value = mock_client_instance
    mock_client_instance.retrieve_docdb_records.return_value = [{
...
@patch("zombie_squirrel.acorn_helpers.source_data.MetadataDbClient")
@patch("zombie_squirrel.acorn_helpers.source_data.acorns.TREE")
def test_source_data_force_update(mock_tree, mock_client_class):
    mock_tree.scurry.return_value = pd.DataFrame({
        "name": ["old_derived"], "source_data": ["old_raw"],
        "pipeline_name": ["old_pipeline"], "processing_time": ["2025-01-01_00-00-00"],
    })
    mock_client_instance = MagicMock()
    mock_client_class.return_value = mock_client_instance
    mock_client_instance.retrieve_docdb_records.return_value = [{
