...
| `platform_fib` | Fiber photometry assets with per-fiber targeted structure and intended channel measurement, one row per (asset, fiber) | `s3://allen-data-views/data-asset-cache/zs_platform_fib.pqt` | metadata | False | `asset_name`, `fiber_name`, `targeted_structure`, `intended_measurement` |
