...
![Interrogate](https://img.shields.io/badge/interrogate-90.4%25-brightgreen)
...
| `platform_fib` | Fiber photometry assets with per-fiber targeted structure and intended channel measurement, one row per asset | `s3://allen-data-views/data-asset-cache/zs_platform_fib.pqt` | metadata | False | `asset_name`, `fiber_0_targeted_structure`, `fiber_0_intended_measurement`, `fiber_1_targeted_structure`, `fiber_1_intended_measurement`, `fiber_2_targeted_structure`, `fiber_2_intended_measurement`, `fiber_3_targeted_structure`, `fiber_3_intended_measurement` |
